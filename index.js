...
// patterns
let patterns = [
    require('./patterns/circlesinusoid'),
    require('./patterns/plasma5'),
    //require('./patterns/plasma4'),
    //require('./patterns/plasma3'),
    //require('./patterns/plasma2'),
    require('./patterns/travelingslow'),
    require('./patterns/black'),
